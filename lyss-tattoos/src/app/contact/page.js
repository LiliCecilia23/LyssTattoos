    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div id="contactDiv" className="greenBg" style={{height: "90%", width: "70%", margin: "auto", marginTop: "30px", padding: "50px", borderRadius: "25px"}}>
        <section style={{textAlign: "center"}}>
          <h2 className="mansalva" style={{fontSize: "20pt", color: "#C6444F", marginBottom: "15px", textAlign: "center"}}>Get in Touch</h2>
          <p>Resident Artist @ Ants Tattoo</p>
          <p>15 Tillman Ave, San Jose 95126 CA</p>
          <p>lyssakemi@gmail.com</p>
          <h2 className="mansalva" style={{fontSize: "20pt", color: "#C6444F", marginBottom: "15px", textAlign: "center", marginTop: "20px"}}>Socials</h2>
          <div style={{display: "flex", flexDirection: "row", justifyContent: "center"}}>
            <a href="https://www.instagram.com/lyss.akemi.tattoo/?ref=badge%2F&hl=en" target="_blank">          
            ...
            <a href="https://www.tiktok.com/@lyss.akemi.tattoo" target="_blank">          
